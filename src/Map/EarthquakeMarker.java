...
public class EarthquakeMarker extends CommonMarker
{
	...
	public EarthquakeMarker (PointFeature feature) 
	{
        ...
        // Implementation of abstract method in CommonMarker
    ...
    public void showTitle(PGraphics pg, float x, float y) {
        ...
        float boxLength = 0.6f*title.length()*pg.textSize;

        pg.fill(255,75);
        pg.rect(x, y, boxLength, 75);
        pg.fill(0);
        pg.text(title, x+10, y+15);
        pg.text("Age: " + age + " days ago", x+10, y+30);
        pg.text("Magnitude: " + mag, x + 10, y + 45);
        pg.text("Depth: " + depth, x +10, y +60);
    }
