...
//        location
    ...
    /**
     * Determines if any markers are currently under the mouse cursor, and if 
     * so sets their selected variable to true and returns the marker.
     * @param markers - The list of markers to check.
     * @return 
     */
    private CommonMarker selectMarkerIfHover(List<CommonMarker> markers)
    {
        float x = mouseX;
        float y = mouseY;
