...
import module3.OceanQuakeMarker;
import module3.LandQuakeMarker;
import module3.CityMarker;
...
//            earthquakesURL = "test2.atom";
	...
	private void printQuakes() {
            ...
            for (Marker m : quakeMarkers){
                // Check to see if runtime class of marker is LandQuakeMarker
                // If so, the country property should have been set by th isLand
                // method already. 
                if(m.getClass() == LandQuakeMarker.class){
                    
                    String country = m.getProperty("country").toString();
                    
                    if (countries.keySet().contains(country)){
                        int value = countries.get(country);
                        countries.put(country, value + 1);
                    }
                    else{
	...
	private boolean isInCountry(PointFeature earthquake, Marker country) {
            ...
            if(country.getClass() == MultiMarker.class) {
                    ...
                    // looping over markers contained in MultiMarker
